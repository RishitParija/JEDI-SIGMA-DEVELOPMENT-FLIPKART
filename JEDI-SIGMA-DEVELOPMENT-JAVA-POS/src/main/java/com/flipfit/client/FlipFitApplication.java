        ...
        do {
            ...
            if (choice == 1) {
                ...
                if (role.equalsIgnoreCase("Admin")) {
                    ...
                    if (((GymCustomerServiceImpl) gymCustomerService).validateLogin(username, password)) {
                        // Find customer object
                        GymCustomer customer = null;
                        for (GymCustomer c : GymCustomerServiceImpl.customerList) {
                    ...
                    if (((GymOwnerServiceImpl) gymOwnerService).validateLogin(username, password)) {
                        GymOwner owner = null;
                ...
                // Create Bean
                GymCustomer customer = new GymCustomer(UUID.randomUUID().toString(), username, name, email, password,
                        0.0);
                // Call Service
                gymCustomerService.createCustomer(customer);
                ...
                // Call Service
                gymOwnerService.createGymOwner(owner);
