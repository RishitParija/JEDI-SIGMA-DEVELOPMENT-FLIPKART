...
public interface AdminService {
     ...
     * Gets all gym owners.
     * 
     * @return all gym owners
     */
    java.util.List<com.flipfit.bean.GymOwner> getAllGymOwners();

    /**
     * Gets all gym centres.
     * 
     * @return all gym centres
     */
    java.util.List<com.flipfit.bean.GymCentre> getAllGymCentres();
}
